...
public class Viagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ID_Motorista = new javax.swing.JTextField();
        ID_Passageiro = new javax.swing.JTextField();
        ...
        jLabel1.setText("Banco de Dados - Viagens");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Plano", "Tipo", "ID Passageiro", "ID Motorista"
            }
        ) {
        ...
        ID_Motorista.setBackground(new java.awt.Color(51, 51, 51));
        ID_Motorista.setForeground(new java.awt.Color(255, 255, 255));
        ID_Motorista.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ID_Motorista.setEnabled(false);

        ID_Passageiro.setBackground(new java.awt.Color(51, 51, 51));
        ID_Passageiro.setForeground(new java.awt.Color(255, 255, 255));
        ID_Passageiro.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ID_Passageiro.setEnabled(false);
        ...
        Plano.setBackground(new java.awt.Color(51, 51, 51));
        Plano.setForeground(new java.awt.Color(255, 255, 255));
        Plano.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        jLabel7.setText("ID Motorista");

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("ID Passageiro");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ID_Passageiro, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Plano, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ID, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ID_Motorista, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ID_Passageiro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ID_Motorista, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if (opcao == 0) {
            ...
            String query2 = "SELECT * FROM viagem";
            ...
            try {
                ...
                while (rs.next()) {
                    String[] dados = {
                        ...
                        rs.getString("plano"),
                        rs.getString("tipo"),
                        rs.getString("ID_Passageiro"),
                        rs.getString("ID_Motorista")};
                    model.addRow(dados);
                } //fim WHILE
        ...
        try {
            ...
            //executa a query (select * from passageiro where nome like (pesquisaText.getText() + "%")
                ...
                if(rs.next()) {
                    ...
                    String value2 = rs.getString("plano");
                    String value3 = rs.getString("tipo");
                    String value4 = rs.getString("ID_Passageiro");
                    String value5 = rs.getString("ID_Motorista");

                    //inserindo os valores nos campos de texto
                    ID.setText(value1);
                    Plano.setText(value2);
                    Tipo.setText(value3);
                    ID_Passageiro.setText(value4);
                    ID_Motorista.setText(value5);
    ...
    private javax.swing.JTextField ID_Motorista;
    private javax.swing.JTextField ID_Passageiro;
