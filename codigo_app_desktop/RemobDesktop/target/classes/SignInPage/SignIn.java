...
public class SignIn extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/RemobInitialPage-img.png"))); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(EmptyLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
     ...
     private void carregaDadosUsuario() {
         ...
         if(this.PasswordField.getPassword().length <= 0 || this.UsernameField.getText().equals("")) {
            this.EmptyLabel.setText("Informe um usuário ou senha.");
            return;
        }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(Path))) {
            ...
            if (loginValido) {
                ...
                this.EmptyLabel.setText("Não foi possível realizar o login. Usuário e/ou Senha incorreto(s).");
            }
