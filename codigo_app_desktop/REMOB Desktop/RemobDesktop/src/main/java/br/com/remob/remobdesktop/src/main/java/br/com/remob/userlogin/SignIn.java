        ...
        try (BufferedReader br = new BufferedReader(new FileReader(Path))) {
            ...
            while ((RegisterField = br.readLine()) != null) {
             ...
             Password = userData[1];
                ...
                if (this.UsernameField.getText().equals(User) && this.PasswordField.getText().equals(Password)) {
                    this.setVisible(false);
                } else if (!this.UsernameField.getText().equals(User) || !this.PasswordField.getText().equals(Password)) {
